...
EndFrame.prototype.Descriptor = { code: 0x17, name: 'amqp:end:list' };
EndFrame.prototype.toDescribedType = function() {
  var values = [];
  if (this.error) {
    values.push(this.error);
  }
  return new DescribedType(EndFrame, values);
};

EndFrame.prototype.fromDescribedType = function(describedType) {
