...
CloseFrame.prototype.Descriptor = { code: 0x18, name: 'amqp:close:list' };
CloseFrame.prototype.toDescribedType = function() {
  var values = [];
  if (this.error) {
...
CloseFrame.prototype.fromDescribedType = function(describedType) {
