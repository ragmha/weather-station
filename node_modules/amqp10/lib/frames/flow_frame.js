...
function FlowFrame(options) {
  FlowFrame.super_.call(this, options.channel);
  if (options instanceof DescribedType) {
    this.fromDescribedType(options);
    return;
  }

  u.assertArguments(options, ['incomingWindow', 'nextOutgoingId', 'outgoingWindow']);
...
FlowFrame.prototype.Descriptor = { code: 0x13, name: 'amqp:flow:list' };
...
FlowFrame.prototype.toDescribedType = function() {
  var self = this;
...
FlowFrame.prototype.fromDescribedType = function(describedType) {
