...
var util = require('util'),
    ...
    AMQPFields = require('../types/amqp_composites').Fields,
...
function AttachFrame(options) {
  ...
  if (options.role === constants.linkRole.sender &&
    ...
    throw new errors.ArgumentError('initialDeliveryCount for sender');
...
AttachFrame.prototype.Descriptor = { code: 0x12,  name: 'amqp:attach:list' };
...
AttachFrame.prototype.toDescribedType = function() {
  var self = this;
  var performative = new DescribedType(AttachFrame, {
    ...
    properties: u.coerce(self.properties, AMQPFields),
    encodeOrdering: AttachFrame.prototype.EncodeOrdering
  });
  return performative;
};

AttachFrame.prototype.fromDescribedType = function(describedType) {
