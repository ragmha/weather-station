...
DetachFrame.prototype.Descriptor = { code: 0x16, name: 'amqp:detach:list' };
DetachFrame.prototype.EncodeOrdering = ['handle', 'closed', 'error'];
DetachFrame.prototype.toDescribedType = function() {
  var self = this;
...
DetachFrame.prototype.fromDescribedType = function(describedType) {
