...
errors.wrapProtocolError = function(err) {
  if (err instanceof AMQPError) return new errors.ProtocolError(err.condition.contents, err.description, err.errorInfo);
  return err;
};
 ...
 * @constructor
 */
errors.EncodingError = function(object) {
  errors.BaseError.call(this, 'encoding failure: ' + object);
