...
Session.prototype._processFrame = function(frame) {
  ...
  switch (frame.constructor) {
    case EndFrame: return this._processEndFrame(frame);
    case AttachFrame: return this._processAttachFrame(frame);
    case DetachFrame: return this._processDetachFrame(frame);
    case FlowFrame: return this._processFlowFrame(frame);
    case TransferFrame: return this._processTransferFrame(frame);
    case DispositionFrame: return this._handleDisposition(frame);
    default:
