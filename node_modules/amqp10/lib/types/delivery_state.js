...
Received.prototype.Descriptor = { code: 0x23, name: 'amqp:received:list' };
...
Accepted.prototype.Descriptor = { code: 0x24, name: 'amqp:accepted:list' };
...
function Rejected(options) {
  ...
  if (options instanceof AMQPError) {
    ...
    var errMsg = options.error || "rejected";
    this.error = new AMQPError(AMQPError.InternalError, errMsg);
  }
}

util.inherits(Rejected, DeliveryState);

Rejected.prototype.Descriptor = { code: 0x25, name: 'amqp:rejected:list' };
...
Released.prototype.Descriptor = { code: 0x26, name: 'amqp:released:list' };
...
Modified.prototype.Descriptor = { code: 0x27, name: 'amqp:modified:list' };
